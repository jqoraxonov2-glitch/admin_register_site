...
urlpatterns = [
    ...
    path('subjact/create/',subjact_create, name='subjact_create'),
    path('subjact/<int:pk>/edit/',subjact_edit, name='subjact_edit'),
    path('subjact/<int:pk>/delete/',subjact_delete, name='subjact_delete'),
    path('subjact/list/',subjact_list, name='subjact_list'),
